...
import Tooltip from "../../Collection/Tooltip";
import ProductColors from "../../Collection/Elements/ProductColors";
import SelectBox from "../../Collection/Elements/SelectBox";
...
import BookmarkPopup from "../../Collection/Modals/BookmarkPopup";
                    ...
                    <ul className="duration-700">
                      {product.images.length > 0 &&
                        product.images.map((img, index) => (
                          <li className="mb-5" ref={refs[img]} key={index}>
                            <img
                              src={`${img}`}
                              alt="Avatar"
