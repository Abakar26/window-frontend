...
let array = [];
const notify = () => {
  toast.error("Collection is Private.");
};

const CollectionShareProducts = (props) => {
      ...
      <div
        className={`${
          localStorage.getItem("authorization")
            ? "sm:p-4 flex flex-row w-[calc(100%-290px)] absolute right-0 xlg:w-full xlg:justify-center"
            : "sm:p-4 flex flex-row w-full px-[150px] xlg:w-full xlg:justify-center"
        }`}
      >
        ...
        <div className="flex w-full flex-col pt-11 bg-[#ffffff] p-8">
          ...
          {products ? (
            products.length === 0 ? (
              ...
              <div className="flex w-full justify-center overflowable-height2 mt-4">
...
export default CollectionShareProducts;
